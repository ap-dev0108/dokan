      ...
      {[
        ...
        <div key={item.label} className="flex flex-col items-center">
          <div className="w-16 h-16 bg-dokan-dark text-dokan-light rounded-lg flex items-center justify-center">
            <span className="font-manrope font-bold text-2xl text-gray-300">{String(item.value).padStart(2, "0")}</span>
          </div>
        ...
        <div className="dokan-container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              <p className="font-quicksand text-sm uppercase tracking-widest mb-4 text-gray-300">Special Offer</p>
              <h2 className="font-manrope font-bold text-5xl md:text-6xl mb-4 text-gray-100">Winter Sales</h2>
